...
export class QuestionComponent {
  ...
  // Huitième question
  question8 =
    '8. Est-il possible pour un tireur de diriger son arme vers quelqu’un ?';
  options8: Option[] = [
    { description: 'Oui', isCorrect: false },
  ...
  // Neuvième question
  question9 =
    '9. Un tireur est-il autorisé à faire des simulacres de visée avec une arme, même vide ?';
  options9: Option[] = [
  ...
  // Onzième question
  question11 =
    '11. Pendant que d’autres tireurs sont aux cibles, qu’a le droit de faire un tireur resté au pas de tir ?';
  options11: Option[] = [
  ...
  options12: Option[] = [
    {
      description: 'Obligatoire dans toutes les disciplines',
      isCorrect: false,
    },
  ...
  options13: Option[] = [
    ...
    {
      description: 'Réparer dans le stand en arrière du pas de tir',
      isCorrect: false,
    },
    { description: 'Mettre l’arme en sécurité', isCorrect: true },
    {
      description:
        'Réparer au pas de tir, le canon de l’arme face aux cibles ou labutte de tir',
      isCorrect: true,
    },
  ];
  ...
  question14 =
    '14. Un tireur possède une arme soumise à autorisation de détention. Comment doit-il la stocker à son domicile ?';
  options14: Option[] = [
    {
      description:
    ...
    {
      description: 'La ranger assurée dans une mallette fermée à clef',
      isCorrect: false,
    },
    {
      description:
        'Stocker les munitions de l’arme soumise à autorisation dans le même coffre-fort, armoire forte ou pièce forte',
      isCorrect: false,
    },
  ];
  ...
  // Quinzième question
  question15 =
    '15. Un tireur possède une arme soumise à déclaration ou enregistrement, comment doit-il la stocker à son domicile ? (3 possibilités)';
  options15: Option[] = [
    {
      description: 'La ranger assurée dans une mallette fermant à clé',
      isCorrect: false,
    },
    {
      description: 'L’entreposer dans un coffre-fort ou une armoire forte ',
      isCorrect: true,
    },
    {
      description:
    ...
    {
      description: 'Utiliser un dispositif empêchant l’enlèvement de l’arme',
      isCorrect: true,
    },
  ];
  ...
  question18 =
    '18. Quels éléments faut-il aligner pour réaliser une visée correcte ?';
  options18: Option[] = [
  ...
  question19 =
    '19. Faute pour l’œil de voir net simultanément à différentes distances, quel(s) élément(s) faut- il voir de façon nette ?';
  options19: Option[] = [
  ...
  // Vingtième question
  question20 =
    '20. Pour tirer plus à droite, dans quelle direction faut-il déplacer la hausse ?';
  options20: Option[] = [
  ...
  submitAll() {
    ...
    [
      ...
      options.forEach((option, optionIndex) => {
        if (
          !option.isCorrect &&
          this.getSelectedOptions(index + 1).has(optionIndex)
        ) {
    ...
    const totalErrors =
      totalCorrectAnswers - totalSelectedCorrectAnswers + totalIncorrectAnswers;
  ...
  private getSelectedOptions(questionNumber: number): Set<number> {
    switch (questionNumber) {
      ...
      case 4:
        return this.selectedOptions4;
      case 5:
        return this.selectedOptions5;
      case 6:
        return this.selectedOptions6;
      case 7:
        return this.selectedOptions7;
      case 8:
        return this.selectedOptions8;
      case 9:
        return this.selectedOptions9;
      case 10:
        return this.selectedOptions10;
      case 11:
        return this.selectedOptions11;
      case 12:
        return this.selectedOptions12;
      case 13:
        return this.selectedOptions13;
      case 14:
        return this.selectedOptions14;
      case 15:
        return this.selectedOptions15;
      case 16:
        return this.selectedOptions16;
      case 17:
        return this.selectedOptions17;
      case 18:
        return this.selectedOptions18;
      case 19:
        return this.selectedOptions19;
      case 20:
        return this.selectedOptions20;
      default:
